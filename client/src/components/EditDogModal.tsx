  ...
  return ReactDOM.createPortal(
    <div 
      ...
      style={{
        ...
        paddingTop: window.innerWidth > 768 ? '16px' : '70px',
        paddingBottom: window.innerWidth > 768 ? '16px' : '80px',
    ...
    >
      <div 
        style={{
          ...
          paddingTop: window.innerWidth > 768 ? '1.5rem' : '1.5rem',
          paddingBottom: window.innerWidth > 768 ? '1.5rem' : '2rem',
          width: window.innerWidth > 768 ? '85vw' : '100%',
          height: 'auto',
