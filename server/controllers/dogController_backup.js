...
export const updateDog = async (req, res) => {
  try {
    ...
    // Authorization check: only the user who created the dog can update it
...
export const deleteDog = async (req, res) => {
  try {
    ...
    // Authorization check: only the user who created the dog can delete it
    if (dog.user.toString() !== req.user._id.toString()) {
